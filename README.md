...
- We have included two additional Saturation models suitable for shaly-sand analysis. We started with his Waxman-Smits and Dual-Water saturation models from his repository and then modified his code to employ George Coates' MRIAN Dual-Water and a Waxman-Smits model.
- We have modeled the Clay Bound Water Volume in case there are light hydrocarbon intervals with a reduced Hydrogen Index affecting the well log readings. 
